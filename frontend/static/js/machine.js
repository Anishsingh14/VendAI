  ...
  render() {
    return pageShell('machines', `
      <div class="flex items-center justify-between mb-6">
        ...
        <button class="bg-primary hover:bg-primary-hover text-white text-sm font-medium py-2.5 px-5 rounded-lg transition-colors flex items-center gap-2 shadow-sm" id="add-machine-top"><span class="material-symbols-outlined text-[16px]">add</span>Add Machine</button>
      </div>
      ...
      <div class="mb-6">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-3">
            <button class="bg-white border border-slate-200 hover:border-emerald-300 hover:bg-emerald-50 text-slate-700 text-sm font-medium py-2.5 px-5 rounded-lg transition-colors flex items-center gap-2" id="add-product-btn">
              <span class="material-symbols-outlined text-[16px] text-emerald-600">add_circle</span>Add Product
            </button>
            <button class="bg-primary hover:bg-primary-hover text-white text-sm font-medium py-2.5 px-5 rounded-lg transition-colors flex items-center gap-2 shadow-sm" onclick="Router.navigate('upload',{machineId:'${state.id}',machineName:'${state.name}'})">
